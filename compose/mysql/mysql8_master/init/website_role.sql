...
CREATE TABLE `role` (
  ...
  `resources` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
...
INSERT INTO `role` VALUES (1,'超级管理员','1,2,3,4,5,6,7,8',1,'',0),(2,'操作员','1,2,3,4,5,6,7,8',1,'',0),(3,'审计员','1',1,'',0),(4,'其他','',1,'',0);
